            ...
            "runs": [{
                "tool": {
                    "driver": {
                        ...
                        "informationUri": "https://github.com/kayelohbyte/scour-secrets",
                        "rules": rules
                    }
                },
                "invocations": [{
...
<title>scour-secrets report</title>
<style>
...
<footer>Generated by <strong>scour-secrets {version}</strong> on {timestamp}</footer>
</div>
</body>
</html>"#,
...
mod tests {
    ...
    fn sarif_driver_name_and_version() {
        ...
        assert_eq!(driver["name"], "scour-secrets");
    ...
    fn html_is_valid_document() {
        ...
        assert!(html.contains("<title>scour-secrets report</title>"));
    }
